...
class MUSDB18Dataset(Dataset):
    ...
    def __init__(self, base_path: str, subset: str, split: str, target: str,
                 duration: Optional[float], divisions: int = 1, random: bool = False) -> None:
        """
        ...
        divisions -- En cuantas partes se va a dividir una canción
    ...
    def __getitem__(self, index: int) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        track = self.mus[index // self.divisions]
    ...
    def __len__(self) -> int:
        return len(self.mus) * self.divisions
